...
{
    pyramidAddQuadFace(0,1,2,3,vec3(0,-1,0));
    pyramidAddTriFace(0,1,4, normalize(cross(subtract(pyramid_vertices[0], pyramid_vertices[1]), subtract(pyramid_vertices[0], pyramid_vertices[4]))));
    pyramidAddTriFace(1,2,4, normalize(cross(subtract(pyramid_vertices[1], pyramid_vertices[2]), subtract(pyramid_vertices[1], pyramid_vertices[4]))));
    pyramidAddTriFace(2,3,4, normalize(cross(subtract(pyramid_vertices[2], pyramid_vertices[3]), subtract(pyramid_vertices[2], pyramid_vertices[4]))));
    pyramidAddTriFace(3,0,4, normalize(cross(subtract(pyramid_vertices[3], pyramid_vertices[0]), subtract(pyramid_vertices[3], pyramid_vertices[4]))));
}
...
function pyramidAddQuadFace(a, b, c, d, n){
...
function pyramidAddTriFace(a, b, c, n){
    var offset = pyramid_points.length;
    ...
    // Add 1 triangular faces (a,b,c) and (a,c,d)
    pyramid_faces.push(offset);
    pyramid_faces.push(offset+1);
    pyramid_faces.push(offset+2);
